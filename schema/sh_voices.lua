...
Schema.voices.Add("Combine", "BELIEVEWHATYOUWANT", "You can believe what you want.", "npc/metropolice/mc1ans_believewhatyouwant.wav")
Schema.voices.Add("Combine", "BELLYACHING", "Quit your bellyaching.", "blnpc/metropolice/mc1ans_bellyaching.wav")
Schema.voices.Add("Combine", "COULDBE", "Could be.", "npc/metropolice/mc1ans_couldbe.wav")
Schema.voices.Add("Combine", "DONTRIDICULOUS", "Dont be ridiculous.", "npc/metropolice/mc1ans_dontridiculous.wav")
Schema.voices.Add("Combine", "DONTWANNATALK", "I dont wanna talk about it.", "npc/metropolice/mc1ans_dontwannatalk.wav")
...
Schema.voices.Add("Combine", "HELLUVAMOOD", "You're in helluva mood.", "npc/metropolice/mc1ans_helluvamood.wav")
Schema.voices.Add("Combine", "MIGHTBE", "Might be.", "npc/metropolice/mc1ans_mightbe.wav")
Schema.voices.Add("Combine", "MIGHTCOULD", "Might could.", "npc/metropolice/mc1ans_mightcould.wav")
Schema.voices.Add("Combine", "MIGHTNOT", "Might not.", "npc/metropolice/mc1ans_mightnot.wav")
Schema.voices.Add("Combine", "RATHERNOTTHINK", "I'd rather not think about that.", "npc/metropolice/mc1ans_rathernotthink.wav")
Schema.voices.Add("Combine", "SHUTUP", "Ugh, shut up about that.", "npc/metropolice/mc1ans_shutup.wav")
Schema.voices.Add("Combine", "STOPWHINING", "Stop whining.", "npc/metropolice/mc1ans_stopwhining.wav")
Schema.voices.Add("Combine", "THERESYOURPROBLEM", "There's your problem right there.", "npc/metropolice/mc1ans_theresyerproblem.wav")
Schema.voices.Add("Combine", "THINKSO", "Think so.", "npc/metropolice/mc1ans_thinkso.wav")
...
Schema.voices.Add("Combine", "YOUEXPECTME", "You expect me to believe that?", "npc/metropolice/mc1ans_youexpectme.wav")
Schema.voices.Add("Combine", "YOUFORPARTNER", "Huh, had to get you for a partner.", "npc/metropolice/mc1ans_youforpartner.wav")
Schema.voices.Add("Combine", "YOUREALLYBELIEVE", "You really believe that?", "npc/metropolice/mc1ans_youreallybelieve.wav")
Schema.voices.Add("Combine", "YUP", "Yup.", "npc/metropolice/mc1ans_yup.wav")
Schema.voices.Add("Combine", "YUP2", "Yup!", "npc/metropolice/mc1ans_yup2.wav")
Schema.voices.Add("Combine", "BETTERTHINGS", "I got better things to do.", "npc/metropolice/mc1que_betterthings.wav")
Schema.voices.Add("Combine", "CAREER", "Yep, this is definetly the best career choice I ever made.", "npc/metropolice/mc1que_career.wav")
Schema.voices.Add("Combine", "ENLISTING", "Sooo, im thinking of enlisting.", "npc/metropolice/mc1que_enlisting.wav")
Schema.voices.Add("Combine", "EVERYTHINGHOPED", "Yep, this is everything I hoped it would be.", "npc/metropolice/mc1que_everythinghoped.wav")
Schema.voices.Add("Combine", "FEELINGGOOD", "Im feeling pretty good about myself today.", "npc/metropolice/mc1que_feelinggood.wav")
Schema.voices.Add("Combine", "FEETKILLING", "My feet are killin' me.", "npc/metropolice/mc1que_feetkilling.wav")
Schema.voices.Add("Combine", "GOINGTOHELL", "This hole place is going to hell, well. Not this place.", "npc/metropolice/mc1que_goingtohell.wav")
Schema.voices.Add("Combine", "KIDSTOSEETHIS", "I wouldn't have kids even if they let me.", "npc/metropolice/mc1que_kids.wav")
Schema.voices.Add("Combine", "PAYCUT", "What you wanna bet we'll get a paycut?", "npc/metropolice/mc1que_paycut.wav")
Schema.voices.Add("Combine", "PEOPLESUCK", "People suck. Well, except for us, I mean.", "npc/metropolice/mc1que_peoplesuck.wav")
Schema.voices.Add("Combine", "PERKS", "So, you getting the perks they've promised you?", "npc/metropolice/mc1que_perks.wav")
Schema.voices.Add("Combine", "RAISE", "I need a raise.", "npc/metropolice/mc1que_raise.wav")
Schema.voices.Add("Combine", "RIDICULOUS", "Dont be ridiculous.", "npc/metropolice/mc1que_ridiculous.wav")
Schema.voices.Add("Combine", "STIMPATCH", "I could use another stimpatch.", "npc/metropolice/mc1que_stimpatch.wav")
Schema.voices.Add("Combine", "STOMACHKILLING", "My stomach's killin' me.", "npc/metropolice/mc1que_stomach.wav")
Schema.voices.Add("Combine", "STUNSTICKSTHISYEAR", "I heared we're getting our new stunsticks this year.", "npc/metropolice/mc1que_stunsticks.wav")
Schema.voices.Add("Combine", "YOURWIFE", "Your wife doesn't like me, does she?", "npc/metropolice/mc1que_yourwife.wav")
Schema.voices.Add("Combine", "JUSTTHOUGHT", "I just thought of something, uh, wait, maybe not.", "npc/metropolice/mc1que_justthought.wav")
